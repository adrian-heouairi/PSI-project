...
\begin{itemize}
    ...
    \item \mintinline{go}{msgQueue} liste doublement chainée (\mintinline{go}{list.List}) protégée par un \mintinline{go}{RWMutex} : stocke les réponses (type >= 128) qui doivent être récupérées par le thread qui a envoyé une requête.
\end{itemize}
